...
public class NewCustomer extends JFrame implements ActionListener, java.awt.event.ActionListener {
    ...
    NewCustomer() {
        ...
        cancle.setBounds(350, 390, 100, 20);
